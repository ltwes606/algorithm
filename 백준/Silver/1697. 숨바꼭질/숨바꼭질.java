...
public class Main {
    ...
    private static void visit(int[] result, Queue<Integer> queue,
        ...
        if (result[originalPoint] + 1 < result[visitPoint]) {
            result[visitPoint] = result[originalPoint] + 1;
